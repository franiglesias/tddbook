...
Una vez que tenemos esto claro, escribimos un test que enviará un POST al *end point* para crear una tarea nueva y verificará que, en algún momento, estamos llamando a un repositorio de tareas, confiando en que la implementación real lo gestionará correctamente cuando esté disponible.
...
* Obtener la respuesta del caso de uso y enviarla como respuesta del *end point*
