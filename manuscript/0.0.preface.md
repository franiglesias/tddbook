...
Usando el siguiente enlace podrás acceder a una copia digital gratuita del libro. Con ella dispondrás de las actualizaciones de contenido que se puedan ir añadiendo.

```
https://leanpub.com/tddcourse/c/PRINTED
```
