...
![El ciclo outside-in clasicista](images/Drawings/classic-cycle.jpeg)
...
Para el siguiente punto necesito hacer un salto un poco más grande y preparar el cliente que ejecutará las *request*as contra los *end points*. Usando rack-test, puedo crear un cliente del api. Puesto que estoy en verde, voy a introducirlo e iniciarlo. Tendremos que instalar `rack-test` primero.
