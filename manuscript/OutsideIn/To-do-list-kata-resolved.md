...
En lugar de diseñar el sistema en la fase de refactoring, como hace el enfoque clásico, la aproximación outside-in lo hace durante la fase *en rojo*, es decir, cuando el test de aceptación todavía no está fallando. Para hacerlo, la metodología se basa en dos ciclos:
